...
public class KejarActivity extends Activity {
 //deklarasi variabel
	EditText jawabantxt;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_kejar);
    ...
    public void cek(View v){
    	String jawabanBenar = "KEJAR WAKTU";
    	...
    	if(jawabanUser.equals(jawabanBenar)){
    		...
    		Intent i = new Intent(getApplicationContext(),KerisActivity.class);
    		startActivity(i);
